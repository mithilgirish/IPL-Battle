...
import { Timer, Users, DollarSign, Award, ArrowDown, Shield, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">Budget: <span className="text-yellow-400">70 Crores</span></span>
              </div>
              <div className="flex items-center space-x-3">
                <Users className="w-5 h-5 text-yellow-400" />
                <span className="text-gray-300">Players: <span className="text-yellow-400">16-18</span></span>
              </div>
              <div className="flex items-center space-x-3">
                <Award className="w-5 h-5 text-yellow-400" />
                <span className="text-gray-300">Players are rated out of <span className="text-yellow-400">50</span></span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50 text-center">
              <span className="text-gray-300">Maximum of <span className="text-yellow-400">7</span> foreign players</span>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gray-900/50 backdrop-blur-xl rounded-3xl p-8 border border-gray-800 mb-16">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
              <span className="text-gray-300">At most <span className="text-yellow-400">5</span> foreign players</span>
            </div>
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
              <span className="text-gray-300">At least <span className="text-yellow-400">2</span> all-rounder</span>
            </div>
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
              <span className="text-gray-300">At least <span className="text-yellow-400">1</span> Wicket Keeper</span>
            </div>
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
              <span className="text-gray-300">At least <span className="text-yellow-400">3</span> Bowlers</span>
            </div>
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50 md:col-span-2">
              <span className="text-gray-300">At least <span className="text-yellow-400">3</span> batsmen</span>
            </div>
          </div>

          <div className="space-y-6">
            <h4 className="text-xl font-semibold text-blue-400 mb-4 text-center">Evaluation criteria</h4>
            <div className="space-y-3 text-gray-300">
              <div className="flex items-center space-x-3 bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                ...
                <span>Sum of 11 players rating out will be considered</span>
              </div>
              <div className="flex items-center space-x-3 bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50">
                <span className="text-yellow-400">2.</span>
                <span>In case of a tie, the remaining balance will be taken into consideration</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-8 bg-gradient-to-r from-white to-gray-400 text-transparent bg-clip-text">
          Code of Conduct
        </h2>
        ...
        <div className="space-y-4">
          {[
            ...
            <div 
              key={index}
              className="flex items-start space-x-4 bg-gray-800/30 backdrop-blur-sm rounded-xl p-4 border border-gray-700/50 transform transition-all duration-300 hover:bg-gray-800/50"
            >
