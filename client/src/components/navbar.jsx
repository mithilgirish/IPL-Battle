...
import { Zap, Sparkles, X, Menu } from 'lucide-react'; // Import Lucide icons
        ...
        <span className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent font-mono">
          E-CELL
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a
                href="/"
                className="group relative text-gray-300 hover:text-white transition-all"
              >
              ...
              <Button className="relative overflow-hidden bg-gradient-to-r from-green-500 to-cyan-500 hover:from-green-400 hover:to-cyan-400 px-6 py-2 rounded-full font-medium text-gray-900 hover:text-gray-950 transition-all group">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-950/95 backdrop-blur-xl border-b border-gray-800/50">
            <div className="px-4 py-3 space-y-3">
              ...
              <Button className="w-full bg-gradient-to-r from-green-500 to-cyan-500 text-gray-900 font-medium mt-2">
                Login
              </Button>
            </div>
          </div>
